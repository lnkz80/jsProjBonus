...
var showHidePreview = function showHidePreview() {
  var ramaIcons = document.querySelectorAll('.balcon_icons_img'),
      ramaBigImg = document.querySelectorAll('.big_img img');
  ramaBigImg[0].classList.add('show');
  ramaIcons.forEach(function (icon, idx) {
    icon.addEventListener('click', function (e) {
      Object(_services_helpers__WEBPACK_IMPORTED_MODULE_1__["showHideTab"])(ramaBigImg, idx);
      Object(_services_helpers__WEBPACK_IMPORTED_MODULE_1__["removeClassFromAllElements"])(ramaIcons, 'do_image_more');
...
var calc = function calc() {
  ...
  showHidePreview(); //?===== temp option for dev =====>

  popupCalc.style.display = "block"; //?===============================<

  popupCalc.querySelector('.button').addEventListener('click', function () {
    var width = +document.getElementById('width').value,
        height = +document.getElementById('height').value;

    if (!Object(_services_helpers__WEBPACK_IMPORTED_MODULE_1__["isNumber"])(width) || !Object(_services_helpers__WEBPACK_IMPORTED_MODULE_1__["isNumber"])(height) || width <= 0 || height <= 0) {
      alert("Please, enter only numbers in fields...");
      return false;
    }

    calcData.width = width;
    calcData.height = height; //! Add transition to 2nd modal window 
  ...
  currentForm.forEach(function (form) {
    form.querySelector("button").addEventListener("click", function (e) {
      ...
      Object(_services_postData__WEBPACK_IMPORTED_MODULE_7__["default"])(reqUrl, postObj).then(function (data) {
        ...
        _this.style.filter = "grayscale(0%)";
        form.reset();
        var span = document.createElement("span");
        span.style.color = "green";
        span.textContent = "Информация отправлена!";

        _this.parentElement.append(span);
...
var openModal = function openModal(modObj) {
  modObj.classList.remove("hide");
  modObj.classList.add("show");
};

var closeModal = function closeModal(modObj) {
  modObj.classList.remove("show");
  modObj.classList.add("hide");
};

var modal = function modal(modTriggerSelector, modalWindowSelector) {
  var modTrigger = document.querySelectorAll(modTriggerSelector),
      modalWindow = document.querySelector(modalWindowSelector); //open modal window event

  modTrigger.forEach(function (item) {
...
var tabs = function tabs() {
  ...
  tabBlock.forEach(function (block, idx) {
    ...
    block.addEventListener("click", function () {
      Object(_services_helpers__WEBPACK_IMPORTED_MODULE_1__["showHideTab"])(tabContent, idx);
    });
  });
};
...
/*!************************************!*\
  !*** ./src/js/services/helpers.js ***!
  \************************************/
/*! exports provided: showHideTab, removeClassFromAllElements, isNumber */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var removeClassFromAllElements = function removeClassFromAllElements(el, rmClass) {
  return el.forEach(function (item) {
    return item.classList.remove(rmClass);
  });
};
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return regeneratorRuntime.awrap(fetch(url, data ? postSettings : null));
        ...
        case 4:
          ...
          throw new Error("Could not fetch ".concat(url, ", receive status ").concat(req.status));
