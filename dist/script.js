...
const calc = () => {
  ...
  popupCalc.querySelector('.popup_calc_button').addEventListener('click', () => {
    ...
    if (!Object(_services_helpers__WEBPACK_IMPORTED_MODULE_0__["isNumber"])(width) || !Object(_services_helpers__WEBPACK_IMPORTED_MODULE_0__["isNumber"])(height) || width <= 0 || height <= 0) {
      alert("Please, enter only numbers in fields...");
      return false;
    }

    calcData.width = width;
    calcData.height = height; //? Transition to 2nd modal window 
  ...
  popupCalcProfile.querySelector('.popup_calc_profile_button').addEventListener('click', () => {
    calcData.profileType = popupCalcProfile.querySelector('#view_type').value; //! Make transition to 3nd modal window 
...
__webpack_require__(/*! F:\_WRKFLDR\JS_udemy\jsProjBonus\src\js\main.js */"./src/js/main.js");
module.exports = __webpack_require__(/*! F:\_WRKFLDR\JS_udemy\jsProjBonus\src\js\slider.js */"./src/js/slider.js");
